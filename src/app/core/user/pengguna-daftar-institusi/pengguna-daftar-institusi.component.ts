...
@Component({
  selector: "app-pengguna-daftar-institusi",
  templateUrl: "./pengguna-daftar-institusi.component.html",
  styleUrls: ["./pengguna-daftar-institusi.component.scss"],
})
export class PenggunaDaftarInstitusiComponent implements OnInit, OnDestroy {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  constructor(private zone: NgZone, private _formBuilder: FormBuilder) {}
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      this.getChartUserPendaftarInstitusi1();
      this.getChartUserPendaftarInstitusi2();
    });
  }

  getChartUserPendaftarInstitusi1() {
    ...
    let chart = am4core.create(
      "chartdivpenggunadaftarinstutusi1",
      am4charts.PieChart
    );
  ...
  getChartUserPendaftarInstitusi2() {
    am4core.useTheme(am4themes_dataviz);
    am4core.useTheme(am4themes_animated);
    // Themes end
    ...
    // Create chart instance
    let chart = am4core.create(
      "chartdivpenggunadaftarinstutusi2",
      am4charts.XYChart
    );
