...
export class ReportComponent implements OnInit, OnDestroy {
  ...
  getChart() {
    let chart = am4core.create("chartdivadminlaporan1", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("chartdivadminlaporan2", am4charts.XYChart);
  ...
  getChart2() {
    let chart = am4core.create("chartdivadminlaporan3", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartdivadminlaporan4", am4charts.XYChart);
